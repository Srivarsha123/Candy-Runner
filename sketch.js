...
obstacle1 = loadImage("Img/Obstacles/obstacle1.png");
obstacle2 = loadImage("Img/Obstacles/obstacle2.png");
obstacle3 = loadImage("Img/Obstacles/obstacle3.png");
obstacle4 = loadImage("Img/Obstacles/obstacle4.png");
loading = createImg("Img/loading.gif")
}
...
function setup() {
  ...
  loading.position(600, height/2);
  loading.size(250, 250)
