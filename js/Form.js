class Form{
     constructor(){
        ...
        this.candyRunner = createElement('h1');
     }
     hide(){
        this.title.hide();
        this.dropdown.hide();
     ...
     display(){
        ...
        this.candyRunner.html("CANDY RUSH");
        this.candyRunner.position(550, 300);
        this.candyRunner.style('font-family','Bahnschrift')
        this.candyRunner.style('font-size', '52px');
